...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2023 at 02:54 PM
...
--
-- Dumping data for table `tbl_school_enrollee_prereg`
--

INSERT INTO `tbl_school_enrollee_prereg` (`eid`, `uid`, `sycode`, `gid`, `email`, `fname`, `mname`, `lname`, `average`, `gender`, `street`, `region_text`, `province_text`, `city_text`, `barangay_text`, `status`, `date_created`) VALUES
(1, '202311257574', 9292, 0, 'test@gmail.com', 'Test Enid', 'Test Enid', 'Test Enid', 88, 'MALE', '10 U206 TARRAVILLE SUBDIVISION', 'Region III (Central Luzon)', 'Bulacan', 'Hagonoy', '', 'NOT APPROVED', '2023-11-25'),
(2, '202311257291', 9292, 0, 'test@gmail.com', 'Test Enid', 'Test Enid', 'Test Enid', 88, 'MALE', '10 U206 TARRAVILLE SUBDIVISION', 'Region III (Central Luzon)', 'Bulacan', 'Hagonoy', '', 'NOT APPROVED', '2023-11-25');
...
(1, 'IPHONE 64 TYEST GB TEST ANOTHER', '202311139631', '1', 'uploads/black-tshirt-mockup-isolated-grey-background_114853-571__6_-removebg-preview.png', 'LOST', 'test ', '2023-11-13'),
...
(4, 'IPHONE 64 GB', '101213', '1', 'uploads/chart (1).png', 'LOST', 'TEST 1 ', '2023-11-24'),
(5, 'IPHONE 64 GB - FULL', '65369999', '1', 'uploads/chart (5).png', 'LOST', 'TEST', '2023-11-24'),
(6, 'IPHONE 64 GB TEST ONE', '202311147506', '3', 'uploads/chart.png', 'LOST', 'TEST', '2023-11-24'),
(7, 'IPHONE 64 GB not so fullpaid', '65369999', '1', 'uploads/black-tshirt-man_grande (3).png', 'FOUND', 'testing - for another info that i dont know', '2023-11-24');
...
(1, 1, '202311157575', '11:14 AM', '11:14 AM', '2023-11-25'),
(2, 2, '202311157575', '11:47 AM', '', '2023-11-25'),
(3, 3, '202311157575', '11:49 AM', '', '2023-11-25'),
(4, 13, '202311157575', '11:53 AM', '6:47 PM', '2023-11-25'),
(5, 6, '202311157575', '6:48 PM', '6:49 PM', '2023-11-25');
...
(1, 2, '202311157575', '11:47 AM', '', '2023-11-25'),
(2, 3, '202311157575', '11:49 AM', '', '2023-11-25'),
(3, 13, '202311157575', '11:53 AM', '', '2023-11-25'),
(4, 6, '202311157575', '6:48 PM', '', '2023-11-25');
...
(6, 9292, '202311148085', 1, 'sorry its approved', '', 'COMPLETED', '2023-11-14'),
(7, 9292, '202311147506', 1, 'TESTING ENID', '', 'NEW', '2023-11-14'),
(8, 9292, '202311159889', 1, 'testing enid ulit ulit ulit', '', 'NEW', '2023-11-15'),
(9, 9292, '202311137094', 1, 'test', '', 'NEW', '2023-11-23'),
(10, 9292, '202311137094', 5, 'ADDITIONAL', 'Tita ni enid', 'NEW', '2023-11-23');
...
(13, 6, 'test', '2023-11-23'),
(14, 6, 'This is a pending', '2023-11-23'),
(15, 6, 'test', '2023-11-23');
...
(10, '1', 'BUILDING 1', 'CANTEEN'),
(11, '1', 'CLINIC', 'BUILDING 1'),
(12, '1', 'ROOM 9-A', 'BUILDING 9-A'),
(13, '1', 'ROOM001', 'climnic ni enid');
...
(52, '202311106896', 'revcoreitsolution@gmail.com', 9082, 'USED', '2023-11-16'),
(53, '65369999', 'tricore012@gmail.com', 7249, 'USED', '2023-11-16'),
(54, '202311148085', 'tricore012@gmail.com', 9451, 'USED', '2023-11-16'),
(55, '202311106896', 'revcoreitsolution@gmail.com', 8536, 'UNUSED', '2023-11-23'),
(56, '202311106896', 'revcoreitsolution@gmail.com', 9504, 'UNUSED', '2023-11-23'),
(57, '65369999', 'tricore012@gmail.com', 8925, 'UNUSED', '2023-11-24'),
(58, '202311106896', 'revcoreitsolution@gmail.com', 8660, 'UNUSED', '2023-11-25');
...
--
ALTER TABLE `tbl_school_number_of_time_scan`
  MODIFY `nscid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_school_request_type`
--
ALTER TABLE `tbl_school_request_type`
  MODIFY `req` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_school_student_request_history`
  MODIFY `reqhid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
